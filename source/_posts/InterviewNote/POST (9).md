...
![](http://ovi3ob9p4.bkt.clouddn.com/Interview/a758c8b2-0ac7-438f-90c2-3923ffad6328.png)
...
![](http://ovi3ob9p4.bkt.clouddn.com/Interview/9e5e3cc6-3107-4051-b584-8ff077638fe6.png)

以下是继承 Movie 的多态方案。但是由于一部 Movie 的类别会动态改变，因此这种方案不可行。

![](http://ovi3ob9p4.bkt.clouddn.com/Interview/2a502516-5d34-4eef-8f39-916298a60035.png)

引入 Price 来反应类别信息，通过组合的方式在 Movie 中加入 Price 对象，这样每种类别的计费方式都封装在不同的 Price 子类中，并且 Movie 对象也可以动态改变类别。这种方式可以很好地适应上述提到的变化。

![](http://ovi3ob9p4.bkt.clouddn.com/Interview/c02a83b8-a6b9-4d00-a509-6f0516beaf5e.png)

重构后的时序图和类图：

![](http://ovi3ob9p4.bkt.clouddn.com/Interview/95f4559c-3d2a-4176-b365-4fbc46c76cf1.png)

![](http://ovi3ob9p4.bkt.clouddn.com/Interview/293b9326-02fc-4ad8-8c79-b4a7b5ba60d3.png)
...
![](http://ovi3ob9p4.bkt.clouddn.com/Interview/e024bd7e-fb4e-4239-9451-9a6227f50b00.jpg)
...
![](http://ovi3ob9p4.bkt.clouddn.com/Interview/27c2e0b3-8f95-453d-bedc-6398a8566ce9.jpg)

## 14. Replace Type Code with Subcalsses（以子类取代类型码）

有一个不可变的类型码，它会影响类的行为，以子类取代这个类型码。

![](http://ovi3ob9p4.bkt.clouddn.com/Interview/c41d3977-e0e7-4ee4-93e1-d84f1ae3e20e.jpg)
...
![](http://ovi3ob9p4.bkt.clouddn.com/Interview/81fd1d6f-a3b2-4160-9a0a-1f7cb50ba440.jpg)

## 16. Replace Subclass with Fields（以字段取代子类）

各个子类的唯一差别只在“返回常量数据”的函数上。

![](http://ovi3ob9p4.bkt.clouddn.com/Interview/f2e0cee9-ecdc-4a96-853f-d9f6a1ad6ad1.jpg)
...
![](http://ovi3ob9p4.bkt.clouddn.com/Interview/1c8432c8-2552-457f-b117-1da36c697221.jpg)
...
![](http://ovi3ob9p4.bkt.clouddn.com/Interview/08738dd0-ae8e-404a-ba78-a6b1b7d225b3.jpg)
